    ...
    { 
      ...
      { 
        ...
        if(childKey != "purpose") 
        {
          ...
          name_with_tag = "<h3 id = 'name_h4'> "+ name +"<img class='user_tick' src='https://mahdihat791.github.io/v2/kwitter/tick.png'></h4>";
